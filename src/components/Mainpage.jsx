    ...
    <div name="home" className='w-full h-screen'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#E8F3F1] py-4 max-w-[700px]'>Welcome to my portfolio website. You can check out my projects, and reach me from the contact form at the bottom of the page.</p>
          <div>
          <Link
            to="work" // Specify the ID of the target section
            smooth={true}
            duration={500}
            className="text-[#E8F3F1] group border-2 px-8 py-3 my-2 flex items-center hover:border-[#61dbfb] hover:text-[#61dbfb] max-w-[190px]"
          >
            My Projects
